...
using static MGRawInputLib.Externs.RawInput;
        ...
        internal static class RawInput {
            ...
            static string formatted_input(RAWINPUT input) {
                ...
                if (input.Header.Type == RawInputType.KEYBOARD) {
                    sb.Append($"K: {input.Data.Keyboard.VirtualKey}");
            ...
            [DllImport("user32.dll")] public static extern int GetRawInputData(IntPtr hRawInput,
                RawInputCommand uiCommand, out RAWINPUT pData, ref int pcbSize, int cbSizeHeader);
            ...
            /// </summary>
            [StructLayout(LayoutKind.Sequential)] public struct RAWINPUT {
                /// <summary>
                /// Header for the data.
                /// </summary>
            ...
            [StructLayout(LayoutKind.Sequential)] public struct RawInputHeader {
            ...
            [StructLayout(LayoutKind.Sequential)] public struct RawInputKeyboard {
